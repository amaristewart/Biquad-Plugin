...
public:
    biquadAudioProcessorEditor (biquadAudioProcessor& p,
        ...
        backgroundImage = ImageCache::getFromMemory(EqualizerFile, EqualizerFileSize);
    ...
    void paint (Graphics& g) override
    {
        ...
        g.drawImage(backgroundImage, 0, 0, 1870, 1204, 0, 0, 1870, 1204);
    }
...
private:
    ...
    static const unsigned char EqualizerFile[];
    static const int EqualizerFileSize;
