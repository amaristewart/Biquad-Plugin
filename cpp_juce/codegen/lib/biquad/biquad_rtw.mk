###########################################################################
## Makefile generated for component 'biquad'. 
## 
## Makefile     : biquad_rtw.mk
## Generated on : Wed Nov 27 23:59:07 2024
## Final product: ./biquad.a
...
START_DIR                 = /Users/amaristewart/Documents/GitHub/Biquad-Plugin/matlab
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/biquad -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=biquad
...
SRCS = $(START_DIR)/codegen/lib/biquad/rt_nonfinite.cpp $(START_DIR)/codegen/lib/biquad/rtGetNaN.cpp $(START_DIR)/codegen/lib/biquad/rtGetInf.cpp $(START_DIR)/codegen/lib/biquad/biquad.cpp
...
OBJS = rt_nonfinite.o rtGetNaN.o rtGetInf.o biquad.o
...
%.o : $(START_DIR)/codegen/lib/biquad/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/biquad/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/biquad/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/biquad/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/biquad/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.o : $(START_DIR)/codegen/lib/biquad/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/codegen/lib/biquad/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/codegen/lib/biquad/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


biquad.o : $(START_DIR)/codegen/lib/biquad/biquad.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
