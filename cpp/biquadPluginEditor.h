...
{
public:
    biquadAudioProcessorEditor (biquadAudioProcessor& p,
            AudioProcessorValueTreeState& vts)
        : AudioProcessorEditor (&p), processor (p), valueTreeState (vts), tooltip(this),
        Vintage_KnobLnF(Vintage_KnobFile, Vintage_KnobFileSize, 64, 64),
        ...
        Vintage_KnobLnF.setDefaultSansSerifTypeface(noto);
        switch_metalLnF.setDefaultSansSerifTypeface(noto);

        backgroundImage = ImageCache::getFromMemory(scrapFile, scrapFileSize);

        widgets.add (new SliderKnob(*this, vts, "GAIN_DB", "below", "rotaryknob", "editbelow", 0, {45, 695, 85, 25}, {45, 730, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "ATTACK", "below", "rotaryknob", "editbelow", 0, {425, 695, 85, 25}, {425, 730, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "RELEASE", "below", "rotaryknob", "editbelow", 0, {615, 695, 85, 25}, {615, 730, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "THRESHOLD", "below", "rotaryknob", "editbelow", 0, {235, 695, 85, 25}, {235, 730, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "RATIO", "below", "rotaryknob", "editbelow", 0, {805, 695, 85, 25}, {805, 730, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new ToggleRocker(*this, vts, "BYPASS_COMPRESSOR", "none", { "off", "on" }, {0, 0, 0, 0}, {615, 600, 85, 85}, &switch_metalLnF));
        widgets.add (new SliderKnob(*this, vts, "HS_FREQ", "below", "rotaryknob", "editbelow", 1, {615, 175, 85, 25}, {615, 210, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HS_Q", "below", "rotaryknob", "editbelow", 1, {615, 305, 85, 25}, {615, 340, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HS_GAIN", "below", "rotaryknob", "editbelow", 0, {615, 435, 85, 25}, {615, 470, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_FREQ", "below", "rotaryknob", "editbelow", 1, {425, 175, 85, 25}, {425, 210, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_Q", "below", "rotaryknob", "editbelow", 1, {425, 305, 85, 25}, {425, 340, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_GAIN", "below", "rotaryknob", "editbelow", 0, {425, 435, 85, 25}, {425, 470, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_FREQ", "below", "rotaryknob", "editbelow", 1, {235, 175, 85, 25}, {235, 210, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_Q", "below", "rotaryknob", "editbelow", 1, {235, 305, 85, 25}, {235, 340, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_GAIN", "below", "rotaryknob", "editbelow", 0, {235, 435, 85, 25}, {235, 470, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HPF_FREQ", "below", "rotaryknob", "editbelow", 1, {45, 175, 85, 25}, {45, 210, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HPF_Q", "below", "rotaryknob", "editbelow", 1, {45, 305, 85, 25}, {45, 340, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LPF_FREQ", "below", "rotaryknob", "editbelow", 1, {805, 175, 85, 25}, {805, 210, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LPF_Q", "below", "rotaryknob", "editbelow", 1, {805, 305, 85, 25}, {805, 340, 85, 85}, &Vintage_KnobLnF));
        widgets.add (new DropDown(*this, vts, "typeHMF", "none", { "Band", "Peaking", "Notch" }, {0, 0, 0, 0}, {425, 140, 85, 25}, &switch_metalLnF));
        widgets.add (new DropDown(*this, vts, "typeLMF", "none", { "Band", "Peaking", "Notch" }, {0, 0, 0, 0}, {235, 140, 85, 25}, &switch_metalLnF));
        widgets.add (new ToggleRocker(*this, vts, "BYPASS_BIQUAD", "none", { "off", "on" }, {0, 0, 0, 0}, {615, 45, 85, 85}, &switch_metalLnF));
    ...
    void paint (Graphics& g) override
    {
        ...
        g.drawImage(backgroundImage, 0, 0, 960, 1152, 0, 0, 960, 1152);
    }
...
private:
    ...
    FilmstripLookAndFeel Vintage_KnobLnF;
    FilmstripLookAndFeel switch_metalLnF;

    OwnedArray<ParamWidget> widgets;
	Image backgroundImage;
    static const unsigned char Vintage_KnobFile[];
    static const int Vintage_KnobFileSize;
    static const unsigned char scrapFile[];
    static const int scrapFileSize;
...
#include "biquadPluginEditorResources.h"
