...
public:
    biquadAudioProcessorEditor (biquadAudioProcessor& p,
        ...
        widgets.add (new SliderKnob(*this, vts, "HS_FREQ", "below", "rotaryknob", "editbelow", 1, {680, 508, 120, 64}, {680, 582, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HS_Q", "below", "rotaryknob", "editbelow", 1, {680, 720, 120, 64}, {680, 794, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HS_GAIN", "below", "rotaryknob", "editbelow", 0, {680, 932, 120, 64}, {680, 1006, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_FREQ", "below", "rotaryknob", "editbelow", 1, {480, 508, 120, 64}, {480, 582, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_Q", "below", "rotaryknob", "editbelow", 1, {480, 720, 120, 64}, {480, 794, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HMF_GAIN", "below", "rotaryknob", "editbelow", 0, {480, 932, 120, 64}, {480, 1006, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_FREQ", "below", "rotaryknob", "editbelow", 1, {280, 508, 120, 64}, {280, 582, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_Q", "below", "rotaryknob", "editbelow", 1, {280, 720, 120, 64}, {280, 794, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LMF_GAIN", "below", "rotaryknob", "editbelow", 0, {280, 932, 120, 64}, {280, 1006, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HPF_FREQ", "below", "rotaryknob", "editbelow", 1, {80, 508, 120, 64}, {80, 582, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "HPF_Q", "below", "rotaryknob", "editbelow", 1, {80, 720, 120, 64}, {80, 794, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LPF_FREQ", "below", "rotaryknob", "editbelow", 1, {880, 508, 120, 64}, {880, 582, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new SliderKnob(*this, vts, "LPF_Q", "below", "rotaryknob", "editbelow", 1, {880, 720, 120, 64}, {880, 794, 120, 128}, &Vintage_KnobLnF));
        widgets.add (new DropDown(*this, vts, "typeHMF", "none", { "Band", "Peaking", "Notch" }, {0, 0, 0, 0}, {480, 434, 120, 64}, &switch_metalLnF));
        widgets.add (new DropDown(*this, vts, "typeLMF", "none", { "Band", "Peaking", "Notch" }, {0, 0, 0, 0}, {280, 434, 120, 64}, &switch_metalLnF));
        widgets.add (new ToggleRocker(*this, vts, "BYPASS_BIQUAD", "none", { "off", "on" }, {0, 0, 0, 0}, {680, 84, 120, 128}, &switch_metalLnF));
